...
testInsert()
{
    ...
    {
      fixed_string<30> fs1 = "0123456789";
    ...
    BOOST_TEST(testI(S(""), 0, "", 0, S("")));
    BOOST_TEST(testI(S(""), 0, "12345", 0, S("")));
    BOOST_TEST(testI(S(""), 0, "12345", 1, S("1")));
    BOOST_TEST(testI(S(""), 0, "12345", 2, S("12")));
    BOOST_TEST(testI(S(""), 0, "12345", 4, S("1234")));
    BOOST_TEST(testI(S(""), 0, "12345", 5, S("12345")));
    BOOST_TEST(testI(S(""), 0, "1234567890", 0, S("")));
    BOOST_TEST(testI(S(""), 0, "1234567890", 1, S("1")));
    BOOST_TEST(testI(S(""), 0, "1234567890", 5, S("12345")));
    BOOST_TEST(testI(S(""), 0, "1234567890", 9, S("123456789")));
    BOOST_TEST(testI(S(""), 0, "1234567890", 10, S("1234567890")));
    BOOST_TEST(testI(S(""), 0, "12345678901234567890", 0, S("")));
    BOOST_TEST(testI(S(""), 0, "12345678901234567890", 1, S("1")));
    BOOST_TEST(testI(S(""), 0, "12345678901234567890", 10, S("1234567890")));
    BOOST_TEST(testI(S(""), 0, "12345678901234567890", 19, S("1234567890123456789")));
    BOOST_TEST(testI(S(""), 0, "12345678901234567890", 20, S("12345678901234567890")));
    BOOST_TEST(testI(S(""), 1, "", 0, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345", 0, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345", 1, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345", 2, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345", 4, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345", 5, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "1234567890", 0, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "1234567890", 1, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "1234567890", 5, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "1234567890", 9, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "1234567890", 10, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345678901234567890", 0, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345678901234567890", 1, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345678901234567890", 10, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345678901234567890", 19, S("can't happen")));
    BOOST_TEST(testI(S(""), 1, "12345678901234567890", 20, S("can't happen")));
    BOOST_TEST(testI(S("abcde"), 0, "", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345", 1, S("1abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345", 2, S("12abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345", 4, S("1234abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345", 5, S("12345abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "1234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "1234567890", 1, S("1abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "1234567890", 5, S("12345abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "1234567890", 9, S("123456789abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "1234567890", 10, S("1234567890abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345678901234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345678901234567890", 1, S("1abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345678901234567890", 10, S("1234567890abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345678901234567890", 19, S("1234567890123456789abcde")));
    BOOST_TEST(testI(S("abcde"), 0, "12345678901234567890", 20, S("12345678901234567890abcde")));
    BOOST_TEST(testI(S("abcde"), 1, "", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345", 1, S("a1bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345", 2, S("a12bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345", 4, S("a1234bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345", 5, S("a12345bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "1234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 1, "1234567890", 1, S("a1bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "1234567890", 5, S("a12345bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "1234567890", 9, S("a123456789bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "1234567890", 10, S("a1234567890bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345678901234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345678901234567890", 1, S("a1bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345678901234567890", 10, S("a1234567890bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345678901234567890", 19, S("a1234567890123456789bcde")));
    BOOST_TEST(testI(S("abcde"), 1, "12345678901234567890", 20, S("a12345678901234567890bcde")));
    BOOST_TEST(testI(S("abcde"), 2, "", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345", 1, S("ab1cde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345", 2, S("ab12cde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345", 4, S("ab1234cde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345", 5, S("ab12345cde")));
    BOOST_TEST(testI(S("abcde"), 2, "1234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 2, "1234567890", 1, S("ab1cde")));
    BOOST_TEST(testI(S("abcde"), 2, "1234567890", 5, S("ab12345cde")));
    BOOST_TEST(testI(S("abcde"), 2, "1234567890", 9, S("ab123456789cde")));
    BOOST_TEST(testI(S("abcde"), 2, "1234567890", 10, S("ab1234567890cde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345678901234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345678901234567890", 1, S("ab1cde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345678901234567890", 10, S("ab1234567890cde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345678901234567890", 19, S("ab1234567890123456789cde")));
    BOOST_TEST(testI(S("abcde"), 2, "12345678901234567890", 20, S("ab12345678901234567890cde")));
    BOOST_TEST(testI(S("abcde"), 4, "", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 4, "12345", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 4, "12345", 1, S("abcd1e")));
    BOOST_TEST(testI(S("abcde"), 4, "12345", 2, S("abcd12e")));
    BOOST_TEST(testI(S("abcde"), 4, "12345", 4, S("abcd1234e")));
    BOOST_TEST(testI(S("abcde"), 4, "12345", 5, S("abcd12345e")));
    BOOST_TEST(testI(S("abcde"), 4, "1234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 4, "1234567890", 1, S("abcd1e")));
    BOOST_TEST(testI(S("abcde"), 4, "1234567890", 5, S("abcd12345e")));
    BOOST_TEST(testI(S("abcde"), 4, "1234567890", 9, S("abcd123456789e")));
    BOOST_TEST(testI(S("abcde"), 4, "1234567890", 10, S("abcd1234567890e")));
    BOOST_TEST(testI(S("abcde"), 4, "12345678901234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 4, "12345678901234567890", 1, S("abcd1e")));
    BOOST_TEST(testI(S("abcde"), 4, "12345678901234567890", 10, S("abcd1234567890e")));
    BOOST_TEST(testI(S("abcde"), 4, "12345678901234567890", 19, S("abcd1234567890123456789e")));
    BOOST_TEST(testI(S("abcde"), 4, "12345678901234567890", 20, S("abcd12345678901234567890e")));
    BOOST_TEST(testI(S("abcde"), 5, "", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 5, "12345", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 5, "12345", 1, S("abcde1")));
    BOOST_TEST(testI(S("abcde"), 5, "12345", 2, S("abcde12")));
    BOOST_TEST(testI(S("abcde"), 5, "12345", 4, S("abcde1234")));
    BOOST_TEST(testI(S("abcde"), 5, "12345", 5, S("abcde12345")));
    BOOST_TEST(testI(S("abcde"), 5, "1234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 5, "1234567890", 1, S("abcde1")));
    BOOST_TEST(testI(S("abcde"), 5, "1234567890", 5, S("abcde12345")));
    BOOST_TEST(testI(S("abcde"), 5, "1234567890", 9, S("abcde123456789")));
    BOOST_TEST(testI(S("abcde"), 5, "1234567890", 10, S("abcde1234567890")));
    BOOST_TEST(testI(S("abcde"), 5, "12345678901234567890", 0, S("abcde")));
    BOOST_TEST(testI(S("abcde"), 5, "12345678901234567890", 1, S("abcde1")));
    BOOST_TEST(testI(S("abcde"), 5, "12345678901234567890", 10, S("abcde1234567890")));
    BOOST_TEST(testI(S("abcde"), 5, "12345678901234567890", 19, S("abcde1234567890123456789")));
    BOOST_TEST(testI(S("abcde"), 5, "12345678901234567890", 20, S("abcde12345678901234567890")));
...
testFind()
{
  ...
  string_view v1 = cs1;
  string_view v2 = cs2;
  fixed_string<5> fs1 = cs1;
  fixed_string<4> fs2 = cs2;
  ...
  string_view v3 = cs3;
  string_view v4 = cs4;
  fixed_string<5> fs3 = cs3;
  fixed_string<4> fs4 = cs4;
...
{
  auto c = "12345";
  fixed_string<40> fs = "helloworld!";
  BOOST_TEST(fs.substr(1) == "elloworld!");
}
